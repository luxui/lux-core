 ...
 * storage({ reset: 'name' });
 *
 * @param  {String|ResetConfig} key
 *         The Primary controller of functionality; as a String will indicate
 *         which key to interact with in localStorage, as an Object will allow
 *         additional functionality.
 *
 * @param  {any} value
 *         Any value localStorage will allow for storage.
 *
 * @param  {String} prefix
 *         A value to prefix all storage keys.
 *
 * @param  {Object} store
 *         An API - which matches the browser's localStorage API - to persist
 *         values to.
 *
 * @return {any}
